...
package jp.co.flect.doclets.internal.toolkit.taglets;

import com.sun.javadoc.*;

/**
 * This taglet acts as a wrapper to enable
 * {@link jp.co.flect.doclets.Taglet} type taglets to work
...
public class LegacyTaglet implements Taglet {
    ...
    private jp.co.flect.doclets.Taglet legacyTaglet;

    public LegacyTaglet(jp.co.flect.doclets.Taglet t) {
        legacyTaglet = t;
    }
